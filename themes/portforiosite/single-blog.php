...
<main class="single" id="top">
  <div class="container">
    ...
    <ul class="single__blog">
    <?php if(have_posts()): while(have_posts()): the_post(); ?>
        <li class="single__blog__item">
          <div class="single__blog__item__thumbnail-area thumbnail-area">
          ...
          <div class="single__blog__item__text">
      ...
      <?php else: // 投稿がない場合?>
        <p>まだ投稿がありません。</p>
      <?php endif; ?>
      <a href="/archive-blog/" class="archive-link">Return</a>
    </ul>
  </div>
</main>
