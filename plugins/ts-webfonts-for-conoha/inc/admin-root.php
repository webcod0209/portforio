...
class TypeSquare_Admin_Root extends TypeSquare_Admin_Base
{
    ...
    public function typesquare_post_metabox()
    {
        ...
        foreach ($post_type as $type) {
            add_meta_box('typesquare_post_metabox', __('TypeSquare Webfonts for ConoHa', self::$text_domain), array( $this, 'typesquare_post_metabox_inside' ), $type, 'advanced', 'low');
        }
    }
...
EOM;
    ...
    public function typesquare_admin_menu()
    {
        ...
        echo "</style>";
        echo "<div class='wrap'>";
        echo '<h2>'. __('TypeSquare Webfonts for ConoHa', self::$text_domain). '</h2>';
