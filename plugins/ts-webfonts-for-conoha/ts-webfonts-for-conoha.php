<?php
/*
Plugin Name: TypeSquare Webfonts for ConoHa
Version: 2.0.3
Description: ConoHa WINGで株式会社モリサワが提供するWebフォントサービス「TypeSquare」を利用できるプラグインです。
Author: GMO Internet Group, Inc.
Author URI: https://www.conoha.jp
Plugin URI: https://wordpress.org/plugins/ts-webfonts-for-conoha/
...
class TypeSquare_ST
{
    ...
    public function load_scripts()
    {
        ...
        if (false !== $uid) {
            wp_register_script('typesquare_std', "//code.typesquare.com/static/5b0e3c4aee6847bda5a036abac1e024a/ts307f.js?$query", array( 'jquery' ), $version, false);
